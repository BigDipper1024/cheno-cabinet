const i18n = {
  zh: {
    ...
    serviceInstall: "橱柜安装",
    servicePrefabLabel: "柜体",
    servicePrefab: "代售本地预制柜",
    serviceCounterLabel: "台面",
    serviceCounter: "石头台面 / 台面协调",
    storyEyebrow: "服务案例",
    galleryEyebrow: "完工作品",
    galleryTitle: "案例图片",
    publicEmptyPreview: "案例图片即将更新",
    messageEyebrow: "留言板",
    ...
    copyEnAria: "复制英文文案",
    copyFrAria: "复制法文文案",
    footerText: "橱柜安装、预制柜代售、台面协调和完工案例展示。",
    copied: "已复制",
    copiedAll: "全部文案已复制",
    copyFailed: "复制失败，请手动选择文案。"
  },
  en: {
    brandSub: "Cabinet installation & prefab supply",
    ...
    servicePrefabLabel: "Cabinets",
    servicePrefab: "Local prefab cabinet resale",
    serviceCounterLabel: "Countertop",
    serviceCounter: "Stone countertop / countertop coordination",
    storyEyebrow: "Service case",
    galleryEyebrow: "Finished work",
    galleryTitle: "Project gallery",
    publicEmptyPreview: "Project images coming soon",
    messageEyebrow: "Message board",
    ...
    guestArea: "Home area",
    guestProjectType: "Project type",
    guestTimeline: "Timeline",
    ...
    copyEyebrow: "Generated narrative",
    copyTitle: "Chinese, English, French copy",
    copyAll: "Copy all",
    copyOne: "Copy",
    copyZhAria: "Copy Chinese copy",
    copyEnAria: "Copy English copy",
    copyFrAria: "Copy French copy",
    footerText: "Cabinet installation, prefab cabinet resale, countertop coordination, and finished project showcases.",
    copied: "Copied",
    copiedAll: "All copy copied",
    copyFailed: "Copy failed. Please select the copy manually."
  },
  fr: {
    brandSub: "Installation d'armoires et vente de modules",
    navShowcase: "Projet",
    navGallery: "Photos",
    navAbout: "À propos",
    ...
    servicePrefabLabel: "Armoires",
    servicePrefab: "Revente de modules préfabriqués locaux",
    serviceCounterLabel: "Comptoir",
    serviceCounter: "Comptoir en pierre / coordination de comptoir",
    storyEyebrow: "Cas de service",
    galleryEyebrow: "Réalisation",
    galleryTitle: "Photos du projet",
    publicEmptyPreview: "Les photos du projet arrivent bientôt",
    messageEyebrow: "Tableau de message",
    ...
    guestProjectType: "Type de projet",
    guestTimeline: "Échéancier",
    ...
    audience: "Préférences client",
    styleEyebrow: "Direction visuelle",
    styleTitle: "Choisir un style",
    generate: "Générer les textes",
    emptyPreview: "La couverture de votre projet apparaîtra ici",
    briefStyle: "Style du projet",
    briefMaterials: "Armoires / matériaux",
    briefFocus: "Priorité d'installation",
    copyEyebrow: "Récit généré",
    copyTitle: "Textes chinois, anglais, français",
    copyAll: "Tout copier",
    copyOne: "Copier",
    copyZhAria: "Copier le texte chinois",
    copyEnAria: "Copier le texte anglais",
    copyFrAria: "Copier le texte français",
    footerText: "Installation d'armoires, revente de modules préfabriqués, coordination de comptoirs et projets terminés.",
    copied: "Copié",
    copiedAll: "Tous les textes sont copiés",
    copyFailed: "La copie a échoué. Sélectionnez le texte manuellement."
  }
};
...
const styles = [
  {
    id: "quiet",
    name: "Clean Modern",
    note: "simple lines, tidy finish",
    swatch: "linear-gradient(180deg, #151412, #a4753b 48%, #f2e8d7)",
    zh: "现代简洁",
    en: "clean modern",
    fr: "moderne épuré",
    texture: "线条简洁、安装整齐、整体耐看"
  },
  {
    id: "european",
    name: "Soft European",
    note: "profile detail, balanced storage",
    swatch: "linear-gradient(180deg, #273f57, #dad2c3 52%, #111111)",
    zh: "简欧实用",
    en: "soft European",
    fr: "européen contemporain",
    texture: "带一点门型细节，同时保持实用和耐看"
  },
  {
    id: "warm",
    name: "Warm Practical",
    note: "warm wood, everyday storage",
    swatch: "linear-gradient(180deg, #ded0ba, #8c6a48 48%, #ffffff)",
    zh: "温暖实用",
    en: "warm practical",
    fr: "chaleureux pratique",
    texture: "明亮、温和、强调日常收纳和使用顺手"
  },
  {
    id: "french",
    name: "Classic Detail",
    note: "soft detail, familiar finish",
    swatch: "linear-gradient(180deg, #5a2631, #d7c7b4 50%, #263226)",
    zh: "经典细节",
    en: "classic detail",
    fr: "détail classique",
    texture: "有门型和线条细节，适合偏传统的厨房效果"
  },
  {
    id: "japandi",
    name: "Natural Calm",
    note: "natural grain, ordered storage",
    swatch: "linear-gradient(180deg, #1f3a34, #c6b99f 50%, #f8f4ec)",
    zh: "自然清爽",
    en: "natural calm",
    fr: "naturel calme",
    texture: "自然纹理、清爽秩序、适合明亮干净的空间"
  },
  {
    id: "urban",
    name: "Dark Contrast",
    note: "dark panels, crisp alignment",
    swatch: "linear-gradient(180deg, #101010, #3a3530 50%, #a4753b)",
    zh: "深色对比",
    en: "dark contrast",
    fr: "urbain sombre",
    texture: "适合深色柜体和清楚对比，重点是安装线条整齐"
  }
];
...
const contactEmail = "chenocabinet@gmail.com";
...
function applyLanguage(lang) {
  ...
  $$("[data-i18n]").forEach((node) => {
    ...
    node.textContent = i18n[lang][key] || i18n.zh[key] || node.textContent;
  });
  $$("[data-aria-key]").forEach((node) => {
    const key = node.dataset.ariaKey;
    node.setAttribute("aria-label", i18n[lang][key] || i18n.zh[key] || node.getAttribute("aria-label"));
  });
...
function renderStyles() {
  ...
  styles.forEach((style) => {
    ...
    button.innerHTML = `
      <span class="swatch" style="background:${style.swatch}"></span>
      <span>
  ...
  $$(".style-option").forEach((button) => {
    const active = button.dataset.style === state.styleId;
    button.classList.toggle("is-active", active);
    button.setAttribute("aria-pressed", String(active));
  });
}
...
function publicNarrative(data, style) {
  if (state.lang === "en") {
    return {
      title: data.name,
...
function startBusinessTypewriter() {
  const node = $("#businessText");
  if (!node) return;

  const text = i18n[state.lang].heroText;
  ...
  const step = () => {
    ...
    if (index <= text.length) {
      state.typewriterTimer = window.setTimeout(step, state.lang === "zh" ? 42 : 24);
    } else {
      node.classList.remove("is-typing");
    }
  };
...
function updatePreview() {
  ...
  $("#publicMaterialValue").textContent = data.material;
  $("#publicAudienceValue").textContent = data.audience;
  updateUploadStatus();

  const active = state.images[state.activeImage];
...
function renderGallery() {
  ...
  state.images.forEach((image, index) => {
    ...
    button.type = "button";
    button.innerHTML = `<img src="${image.url}" alt="${escapeText(image.name)}" />`;
    button.classList.toggle("is-active", index === state.activeImage);
    button.addEventListener("click", () => {
...
function copyBlocks(data, style) {
  const zh = `标题：${data.name}｜${style.zh}橱柜安装案例
...
function messageBody() {
  ...
  const values = {
    name: fieldValue("guestName"),
    contact: fieldValue("guestContact"),
    area: fieldValue("guestArea"),
    projectType: fieldValue("guestProjectType"),
    timeline: fieldValue("guestTimeline"),
    notes: fieldValue("guestNotes")
  };
  ...
  return [
    ...
    "",
    `${labels.guestName}: ${values.name}`,
    `${labels.guestContact}: ${values.contact}`,
    `${labels.guestArea}: ${values.area}`,
    `${labels.guestProjectType}: ${values.projectType}`,
    `${labels.guestTimeline}: ${values.timeline || "-"}`,
    `${labels.guestNotes}: ${values.notes || "-"}`,
    "",
...
function handleMessageSubmit(event) {
  ...
  const name = fieldValue("guestName");
  const area = fieldValue("guestArea");
  const subject = encodeURIComponent(messageSubject(name, area));
  const body = encodeURIComponent(messageBody());
  window.location.href = `mailto:${contactEmail}?subject=${subject}&body=${body}`;
  $("#messageStatus").textContent = i18n[state.lang].messageReady;
}
...
function bindEvents() {
  ...
  $$("[data-copy]").forEach((button) => {
    button.addEventListener("click", () => {
      const lang = button.dataset.copy;
      copyText(state.copy[lang] || "", i18n[state.lang].copied);
    });
  });
